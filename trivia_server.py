...
class Server(HTTPServer):
    def _init_(self, address, request_handler):
        super()._init_(address, request_handler)


class RequestHandler(BaseHTTPRequestHandler):
    def _init_(self, request, client_address, server_class):
        self.server_class = server_class
        super()._init_(request, client_address, server_class)
